...
contract EtherstonesRewardManager is Auth {
    ...
    uint256 public nodeCooldown = 1 * 900; // 15 Minutes
...
contract ETHSToken is IBEP20, Auth {
    ...
    function swapBack() internal swapping {
        ...
        bool a;
        bytes memory b;
        (a, b) = payable(marketingFeeReceiver).call{ value: amountAVAXMarketing }('');
        (a, b) = payable(treasuryFeeReceiver).call{ value: amountAVAXTreasury }('');
